...
def versioned_asset_path(path: str, version: str) -> str:
    separator = "&" if "?" in path else "?"
    return f"{path}{separator}v={version}"


def compute_asset_version(site: dict[str, Any]) -> str:
    asset_paths = [
        site["site"]["favicon"],
    ...
    for asset in asset_paths:
        digest.update(local_path(asset).read_bytes())
...
def render_html(data: SiteData) -> str:
    ...
    asset_version = compute_asset_version(data.site)
    rendered = template.substitute(
        ...
        FAVICON=versioned_asset_path(data.site["site"]["favicon"], asset_version),
        BOOTSTRAP_CSS=versioned_asset_path("assets/css/bootstrap.css", asset_version),
        ALL_CSS=versioned_asset_path("assets/css/all.css", asset_version),
        ACADEMICONS_CSS=versioned_asset_path("assets/css/academicons.min.css", asset_version),
        CUSTOM_CSS=versioned_asset_path("assets/css/custom.css", asset_version),
        ...
        JQUERY_JS=versioned_asset_path("assets/js/jquery.min.js", asset_version),
        BOOTSTRAP_JS=versioned_asset_path("assets/js/bootstrap.min.js", asset_version),
        CUSTOM_JS=versioned_asset_path("assets/js/custom.js", asset_version),
